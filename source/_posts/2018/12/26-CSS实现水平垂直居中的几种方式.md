...
[点击查看完整DEMO](http://yanhaijing.com/vertical-center/absolute3.html)
...
这种方法需要在子元素中将文字显示重置为想要的效果，同时需要父元素的高度
...
[点击查看完整DEMO](http://yanhaijing.com/vertical-center/writing-mode.html)
